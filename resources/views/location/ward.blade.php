                                ...
                                <div class="row align-items-end">
                                    <div class="col-lg-8">
                                        <div class="page-header-title">
                                            <div class="d-inline">
                                                <h4>Ward</h4>
                                                <span>View and manage all Wards</span>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="page-header-breadcrumb">
                                            <a href="#largeModal" data-toggle="modal" data-target="#large-Modal" class="text-end" style="float:right;" onclick="clear_input()">
                                                <button class="btn btn-success btn-round" style="background-color: #24b42e;">Add Ward <i class="fa fa-plus"></i></button>
                                            </a> <br>
                ...
                <form id="form" onsubmit="save(event)" enctype="form-data/multipart">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-round" id="region_id" name="region_id"  onchange="getRegionDistrict(this.value)">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-round" id="district_id" name="district_id">
...
<script>
    ...
    function deleteWard(id) {
        var conf = confirm("Are you sure you want to delete a ward  ?");
        if (!conf) {
            return;
        }
