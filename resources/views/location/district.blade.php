                                ...
                                <div class="row align-items-end">
                                    <div class="col-lg-8">
                                        <div class="page-header-title">
                                            <div class="d-inline">
                                                <h4>District</h4>
                                                <span>View and manage all Districts</span>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="page-header-breadcrumb">
                                            <a href="#largeModal" data-toggle="modal" data-target="#large-Modal" class="text-end" style="float:right;" onclick="clear_input()">
                                                <button class="btn btn-success btn-round" style="background-color: #24b42e;">Add District <i class="fa fa-plus"></i></button>
                                            </a> <br>
                ...
                <form id="form" onsubmit="save(event)" enctype="form-data/multipart">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="region_id" id="region_id" class="form-control form-control-round">
...
<script>
    ...
    function deleteDistrict(id) {
        var conf = confirm("Are you sure you want to delete a district  ?");
        if (!conf) {
            return;
        }
