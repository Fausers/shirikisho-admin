                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="mb-2"></div>
                                            <div class="col-md-12">
                                                <h2 class="text-center txt-primary" style="font-weight: normal;">Login</h2>
                                            </div>
                                            <div class="mb-4"></div>
                                        </div>
                                        <div class="form-group form-primary">
                                            <input type="text" name="phone_number" class="form-control form-control-round form-control-center" required="" placeholder="Enter Phone Number">
                                        </div>
                                        <div class="form-group form-primary">
                                                <input type="password" name="password" class="form-control form-control-round form-control-center" required="" placeholder="Enter Password">
