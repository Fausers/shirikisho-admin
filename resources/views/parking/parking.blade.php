                                    ...
                                    <div class="col-lg-4">
                                        <div class="page-header-breadcrumb">
                                            <a href="#largeModal" data-toggle="modal" data-target="#large-Modal" class="text-end" style="float:right;" onclick="clear_input()">
                                                <button class="btn btn-success btn-round" style="background-color: #24b42e;">Adding Parking Area <i class="fa fa-plus"></i></button>
                                            </a> <br>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form id="formfilter" enctype="form-data/multipart">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 text-right">
                                            ...
                                            <button type="submit" class="btn btn-info btn-round btn-min" id="btnfilter">Filter</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
